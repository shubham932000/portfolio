...
function openItem(id) {
	$("#listing-container .f-date, #listing-container .f-title, #listing-container .f-description, #listing-container .links, #listing-container .f-index span, #listing-container .f-subtitle, #listing-container .f-s-description, #listing-container .tech").html("")
	...
	document.querySelector("#listing-container .primary-image-container").src = 'files/imgs/work-back/'+workData[id].id+'/primary.jpg';
	document.querySelector("#listing-container .secondary-image-wrapper img").src = 'files/imgs/work-back/'+workData[id].id+'/secondary.jpg';

	for (i=0; i<workData[id].tech.length; i++) {
		$("#listing-container .tech").append(`<li>${workData[id].tech[i]}</li>`);
	}
